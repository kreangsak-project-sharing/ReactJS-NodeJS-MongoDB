...
userSchema.pre("save", async function (next) {
  try {
    ...
    this.promotioncode = `TS${paddedCounterValue}`;
...
const Establishment01 = mongoose.model("Establishment01", userSchema);

module.exports = Establishment01;
